...
export declare const trustWallet: ({ chains, projectId, walletConnectOptions, walletConnectVersion, ...options }: TrustWalletOptions & InjectedConnectorOptions) => Wallet;
