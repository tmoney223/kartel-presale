...
import {
  ...
  useSignMessage,
  useSwitchNetwork
} from "./chunk-UQL5NHBU.js";
import {
  init_lib22 as init_lib,
  lib_exports20 as lib_exports,
  lib_exports23 as lib_exports2
...
initProvider_fn = async function() {
  const {
    ...
    OPTIONAL_EVENTS,
    OPTIONAL_METHODS
  } = await import("./index.es-6CCTWA47.js");
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    var _a;
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("./dist-NBSV5ESM.js")).default;
...
var WalletConnectLegacyConnector = class extends Connector {
  ...
  async getProvider({
    ...
    if (!__privateGet(this, _provider3) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-GZ5OMZFS.js")).default;
