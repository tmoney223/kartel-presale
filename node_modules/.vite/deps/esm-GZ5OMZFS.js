...
function Y(n) {
  ...
  }, e.h && e.h !== r2 && e.componentWillUnmount(), e.v || (e.h = r2, e.v = { nodeType: 1, parentNode: r2, childNodes: [], contains: function() {
    return true;
  ...
  "node_modules/preact/compat/dist/compat.module.js"() {
    ...
    l.unmount = function(n) {
      ...
      var u = j(r2.__v), o3 = false, i = function() {
        o3 || (o3 = true, e.__R = null, u ? u(c2) : c2());
      };
      e.__R = i;
      var c2 = function() {
        if (!--r2.__u) {
    ...
    l.vnode = function(n) {
      "string" == typeof n.type && function(n2) {
        ...
        for (var i in t) {
          var c2 = t[i];
          if (!("value" === i && "defaultValue" in t && null == c2 || Q && "children" === i && "noscript" === e || "class" === i || "className" === i)) {
            var l2 = i.toLowerCase();
            "defaultValue" === i && "value" in t && null == t.value ? i = "value" : "download" === i && true === c2 ? c2 = "" : "translate" === l2 && "no" === c2 ? c2 = false : "o" === l2[0] && "n" === l2[1] ? "ondoubleclick" === l2 ? i = "ondblclick" : "onchange" !== l2 || "input" !== e && "textarea" !== e || X(t.type) ? "onfocus" === l2 ? i = "onfocusin" : "onblur" === l2 ? i = "onfocusout" : J2.test(i) && (i = l2) : l2 = i = "oninput" : o3 && G2.test(i) ? i = i.replace(K2, "-$&").toLowerCase() : null === c2 && (c2 = void 0), "oninput" === l2 && u[i = l2] && (i = "oninputCapture"), u[i] = c2;
          }
        }
...
//# sourceMappingURL=esm-GZ5OMZFS.js.map
